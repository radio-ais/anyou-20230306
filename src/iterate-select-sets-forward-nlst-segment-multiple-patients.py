...
aresquery = session.query ( db.Metadata02 ).filter ( db.Metadata02.numberofimagesi >= THRESH_SLICE_COUNT ).order_by( db.Metadata02.id.asc() )
# aresquery.reverse()
