...
if __name__ == "__main__":
    import os
    from tqdm import tqdm
    seg = CTLungSegmentor(model=None, device="cuda:3")
    base_dir = "/mnt/yando_2/Databank/1_Radiology/in_house/Lung/RP_KNU_TOTAL_DCM/MYKNUCH/"
    patient_ids = os.listdir(base_dir)
    for patient_id in tqdm(patient_ids):
        image, mask = seg.generate_V2(dicom_folder=f"/mnt/yando_2/Databank/1_Radiology/in_house/Lung/RP_KNU_TOTAL_DCM/MYKNUCH/{patient_id}")
